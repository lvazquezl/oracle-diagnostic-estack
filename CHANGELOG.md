...
digest, no la identidad del firmante. Tag `v0.15.0-oracle19c-lab` sobre `8a62cdd` (PR #4). Validado en el lab: una sesión en la PDB no ve filas de `V$RESOURCE_LIMIT` (FAIL para `PDB`). Por decisión del DBA,
...
## [0.15.0] — 2026-09-22 — `v0.15.0-oracle19c-lab` — `/change security|compatibility` — CHG-ESTACK-ORA19C-LAB-001 — adaptador `oracle_sql` de laboratorio (Oracle 19c, sólo lectura)

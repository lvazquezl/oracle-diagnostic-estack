...
Fase actual: **Fase 8 — Oracle Security & Compliance** (sobre baseline `v0.7.0-backup-recovery-rman`). `oracle-security-analyst` (`v2.0.0`, deepening de manifest plano de Foundation a contrato estructurado completo) y 39 skills `security/*` completamente implementados y probados — ver [docs/PHASE_8_ORACLE_SECURITY_COMPLIANCE.md](docs/PHASE_8_ORACLE_SECURITY_COMPLIANCE.md). Base funcional previa: [docs/PHASE_7_ORACLE_BACKUP_RECOVERY_RMAN.md](docs/PHASE_7_ORACLE_BACKUP_RECOVERY_RMAN.md) (`oracle-backup-recovery-analyst`, 30 skills `rman/*`), [docs/PHASE_6_ORACLE_MULTITENANT.md](docs/PHASE_6_ORACLE_MULTITENANT.md) (`oracle-multitenant-analyst`, 26 skills `multitenant/*`), [docs/PHASE_5_ORACLE_DATAGUARD.md](docs/PHASE_5_ORACLE_DATAGUARD.md) (`oracle-dataguard-analyst`, 21 skills `dataguard/*`), [docs/PHASE_4_RAC_GI_ASM_NETWORK.md](docs/PHASE_4_RAC_GI_ASM_NETWORK.md) (`oracle-rac-analyst`/`oracle-asm-storage-analyst`/`oracle-network-analyst`, 57 skills), [docs/PHASE_3_COMPLETION_HARDENING.md](docs/PHASE_3_COMPLETION_HARDENING.md) + [docs/PHASE_3_ORACLE_PERFORMANCE.md](docs/PHASE_3_ORACLE_PERFORMANCE.md) (`oracle-performance-analyst`, 31 skills `performance/*`), [docs/PHASE_2_ORACLE_CORE.md](docs/PHASE_2_ORACLE_CORE.md) (`oracle-discovery-analyst`/`oracle-dba-analyst`, 18 skills `oracle/*`). Ver [CHANGELOG.md](CHANGELOG.md) y "Known limitations" en el reporte de cierre de cada fase.

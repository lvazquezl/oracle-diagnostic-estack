...
Distribución de madurez: `TESTED_WITH_SYNTHETIC_FIXTURES` 48, `CONTRACT_ONLY` 29, `DISABLED` 1; ningún componente en `PILOT_VALIDATED`, `CERTIFIED` ni `UNSUPPORTED` a nivel de registro (la incompatibilidad por versión o licencia se resuelve por destino en tiempo de ejecución, no en el registro).

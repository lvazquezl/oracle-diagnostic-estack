...
- **RMAN, OS, Capacity, Documentation**: un skill representativo materializado por dominio; el resto `registered` (ver `skills/REGISTRY.md`). OS y Documentation no dependen de la versión Oracle — la tabla los repite igual en las 8 columnas por consistencia estructural con el resto de la matriz.

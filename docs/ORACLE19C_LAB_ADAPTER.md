...
| Colectores | `Q-DISC-IDENTITY-001` (variante V3 `modern_18plus`, hash verificado). Desde `CHG-ESTACK-ORA19C-LAB-002` (propuesto): `Q-ORA-RESOURCE-LIMITS-001` (variante implícita), sólo si el targets file privado los lista — ver [ORACLE19C_LAB_COLLECTORS.md](ORACLE19C_LAB_COLLECTORS.md) |

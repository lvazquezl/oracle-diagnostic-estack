...
# Una major Oracle futura y desconocida (representada aquí como 24.0, normalizada 2400) NO debe
# resolver como compatible en ninguna query Data Guard — es exactamente el defecto que el
# resolver tenía con "max: latest" -> vernum("latest") = 99999 (techo sin límite real).
set -uo pipefail
